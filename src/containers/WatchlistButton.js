    ...
    if (watchlistMovies.includes(movieId)) {
      output = (
        <div onClick={() => this.props.removeWatchlistMovie(movieId)}>
          <svg width="1.17em" height="1em" viewBox="0 0 1792 1536">
            <path
